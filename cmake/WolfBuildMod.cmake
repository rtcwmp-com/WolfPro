...
if(BUILD_CLIENT_MOD)
	...
	if(MSVC)
		target_link_options(cgame PRIVATE /DEF:cgame.def)
	elseif(MINGW)
...
if(BUILD_CLIENT_MOD)
	...
	if(MSVC)
		target_link_options(ui PRIVATE /DEF:ui.def)
	elseif(MINGW)
...
if(BUILD_SERVER_MOD)
	...
	if(MSVC)
		target_link_options(qagame PRIVATE /DEF:qagame.def)
	elseif(MINGW)
...
if(BUILD_MOD_PK3)
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND} -E tar c ${CMAKE_CURRENT_BINARY_DIR}/${MODNAME}/${MODNAME}_bin.pk3 --format=zip $<TARGET_FILE_NAME:ui> $<TARGET_FILE_NAME:cgame> ${MAIN_FILES_LIST}
		DEPENDS cgame ui
