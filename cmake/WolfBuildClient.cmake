...
install(FILES $<TARGET_PDB_FILE:wolfmp> DESTINATION ${INSTALL_DEFAULT_BINDIR} OPTIONAL)
install(FILES $<TARGET_PDB_FILE:wolfded> DESTINATION ${INSTALL_DEFAULT_BINDIR} OPTIONAL)
install(FILES $<TARGET_PDB_FILE:qagame> DESTINATION ${INSTALL_DEFAULT_MODDIR} OPTIONAL)
install(FILES $<TARGET_PDB_FILE:ui> DESTINATION ${INSTALL_DEFAULT_MODDIR} OPTIONAL)
install(FILES $<TARGET_PDB_FILE:cgame> DESTINATION ${INSTALL_DEFAULT_MODDIR} OPTIONAL)